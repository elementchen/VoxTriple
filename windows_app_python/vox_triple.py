...
class VoxTripleApp:
    ...
    async def _auto_connect(self):
        ...
        # First time: do ONE scan to find and save the address
        self._status_text.set("Scanning for ESP32_KB...")
        ...
        self._status_text.set("Not found. Pair via system Bluetooth first.")
