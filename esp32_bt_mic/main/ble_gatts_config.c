...
static void gatts_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param)
{
    ...
    case ESP_GATTS_ADD_CHAR_EVT: {
        ESP_LOGI(TAG, "ADD_CHAR_EVT, status %d, attr_handle %d, uuid 0x%04X",
                 param->add_char.status, param->add_char.attr_handle, param->add_char.uuid.uuid.uuid16);

        /* Assign handles based on UUID */
        if (param->add_char.uuid.uuid.uuid16 == GATTS_CHAR_BTN1_MAP_UUID) {
            s_btn1_map_handle = param->add_char.attr_handle;
            /* Add Button 2 Map characteristic */
        ...
        } else if (param->add_char.uuid.uuid.uuid16 == GATTS_CHAR_BTN2_MAP_UUID) {
            s_btn2_map_handle = param->add_char.attr_handle;
            /* Add Button 3 Map characteristic */
        ...
        } else if (param->add_char.uuid.uuid.uuid16 == GATTS_CHAR_BTN3_MAP_UUID) {
            s_btn3_map_handle = param->add_char.attr_handle;
            /* Add Button Event characteristic */
        ...
        } else if (param->add_char.uuid.uuid.uuid16 == GATTS_CHAR_BTN_EVENT_UUID) {
        ...
        } else if (param->add_char.uuid.uuid.uuid16 == GATTS_CHAR_DEV_STATUS_UUID) {
